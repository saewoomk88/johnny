...
<body>
	...
	<div class="container wrap">
		...
		<h1 class="mt-4 mb-3 board">회원가입</h1>

		<div class="row tablee">

			<form class="frm" id="frm" action="./insert" method="post">
				...
				<div class="form-group">
					<input type="password"
						class="form-control" id="pw1" name="pw1" placeholder="비번">
				</div>
				<div class="form-group">
					<input type="password"
						class="form-control" id="pw" name="pw" placeholder="비번확인">
				</div>
				<div class="form-group">
					<input type="text"
				...
				<div class="form-group">
					<input type="tel"
						class="form-control" id="phone" name="phone" placeholder="핸드폰">
				</div>
				<div class="form-group">
					<input type="text"
				...
				<div class="form-group">
					<input type="hidden"
						class="form-control" id="lv" name="lv" value="1">
				</div>
				<div class="form-group">
					<input type="button" id="save" value="JOIN" class="btn btn-default">
				</div>
