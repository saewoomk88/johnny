...
<body>
	...
	<div class="container wrap">
		...
		<div class="row tablee">
			...
			<form class="frm" id="frm" action="${board}Update" method="post">
				<div class="form-group">
					<input type="text"
						class="form-control" id="title" name="title" value="${Ndto.title }">
				</div>
				<div class="form-group">
					<textarea class="form-control" rows="10" id="contents" name="contents">${Ndto.contents }</textarea>
				</div>
				<div class="form-group">
				...
				<div>
					<input type="hidden" name="writer" value="${Ndto.writer }">
